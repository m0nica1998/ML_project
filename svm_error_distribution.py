...
# ---------------------------------------------------------
# 6. Addestramento finale sul training set completo
# ---------------------------------------------------------
...
plt.title("Distribuzione degli errori sul test set MONK-1")
plt.grid(True)
plt.show()

# ---------------------------------------------------------
# 9. Stampa MSE finale sul test set
# ---------------------------------------------------------
